...
const VideoApresentacaoSistema = () => {
    ...
    <Container>
      <div className="w-full max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl ">
        <div
          ...
          {playVideo && (
            <iframe
              src="https://youtube.com/embed/yNWnUWv4riY"
              title="Video de Apresentação do Sistema de Automação Comercial"
              frameBorder="0"
...
export default VideoApresentacaoSistema;